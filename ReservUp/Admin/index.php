...
<head>
    ...
    integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"
     ...
     <img src="https://cdn.pixabay.com/photo/2014/04/02/10/41/button-304224_960_720.png" 
        style="width: 100PX; max-width: 50px;" >
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <form method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="Nom_P"  required>
              </div>

              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Adresse</label>
                <textarea class="form-control" name="Adresse_P" required></textarea>
              </div>

              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Ville</label>
                <input type="text" class="form-control" name="Ville_P"  required>
              </div>

              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Code postal</label>
                <input type="number" class="form-control" name="Code_Postal_P"  required>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" name="Nb_Chambres"  required>
              </div>

              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Prix</label>
                <input type="number" class="form-control" name="Prix_Nuit" step="0.01" required>
              </div>
              ...
              <button type="submit" name="valider" class="btn btn-success">Ajouter une nouvelle propriété</button>
    ...
    if(isset($_POST['Nom_P']) && isset($_POST['Adresse_P']) && isset($_POST['Ville_P']) && isset($_POST['Code_Postal_P'])
      && isset($_POST['Description']) && isset($_POST['Nb_Chambres']) && isset($_POST['Prix_Nuit']) && isset($_POST['image'])) {
        ...
        && !empty($_POST['Description']) && !empty($_POST['Nb_Chambres']) && !empty($_POST['Prix_Nuit']) && !empty($_POST['image'])) {
            ...
            try {
                ajouter($nom, $Adresse, $Ville, $Cp, $Desc, $Nchambre, $Prix, $Image);
